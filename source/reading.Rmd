...
```{r craigslist-human, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Craigslist webpage of advertisements for one-bedroom apartments.", fig.retina = 2, out.width="100%"}
...
```{r sg1, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Using the SelectorGadget on a Craigslist webpage to obtain the CCS selector useful for obtaining apartment prices.", fig.retina = 2, out.width="100%"}
...
```{r sg3, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Using the SelectorGadget on a Craigslist webpage to obtain a CCS selector useful for obtaining apartment sizes.", fig.retina = 2, out.width="100%"}
...
```{r sg2, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Using the SelectorGadget on a Craigslist webpage to refine the CCS selector to one that is most useful for obtaining apartment sizes.", fig.retina = 2, out.width="100%"}
...
```{r sg4, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Using the SelectorGadget on a Wikipedia webpage.", fig.retina = 2, out.width="100%"}
...
```{r NASA-API-Rho-Ophiuchi, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "(ref:NASA-API-Rho-Ophiuchi)", fig.retina = 2, out.width="60%"}
...
```{r NASA-API-signup, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Generating the API access token for the NASA API", fig.retina = 2, out.width="100%"}
...
```{r NASA-API-limits, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "The NASA website specifies an hourly limit of 1,000 requests.", fig.retina = 2, out.width="100%"}
...
```{r NASA-API-parameters, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = 'The set of parameters that you can specify when querying the NASA "Astronomy Picture of the Day" API, along with syntax, default settings, and a description of each.', fig.retina = 2, out.width="100%"}
