...
|   Prediction           | Truly Malignant | Truly Benign |
| ---------------------- | --------------- | -------------- |
...
it identified 3 malignant observations as benign, and 4 benign observations as
...
But we can also see that the classifier only identified 3 out of 4 total malignant
tumors; in other words, it missed 75% of the malignant cases present in the
