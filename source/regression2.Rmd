...
```{r 08-lin-reg1, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 3.5, fig.width = 4.5, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "Scatter plot of sale price versus size with line of best fit for subset of the Sacramento housing data."}
library(tidyverse)
library(tidymodels)
library(scales)
library(gridExtra)
...
```{r 08-lin-reg2, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Scatter plot of sale price versus size with line of best fit and a red dot at the predicted sale price for a 2,000 square-foot home."}
...
```{r 08-several-lines, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 3.5, fig.width = 4.5,  fig.align = "center", fig.cap = "Scatter plot of sale price versus size with many possible lines that could be drawn through the data points."}
small_plot +
...
```{r 08-verticalDistToMin,  echo = FALSE, message = FALSE, warning = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Scatter plot of sale price versus size with red lines denoting the vertical distances between the predicted values and the observed data points."}
...
```{r 08-fitLM, results = FALSE, message=FALSE, echo = TRUE}
lm_spec <- linear_reg() |>
  set_engine("lm") |>
  set_mode("regression")
...
```{r 08-lm-predict-all, fig.height = 3.5, fig.width = 4.5, warning = FALSE, fig.pos = "H", out.extra="", message = FALSE, fig.align = "center", fig.cap = "Scatter plot of sale price versus size with line of best fit for the full Sacramento housing data."}
...
```{r 08-compareRegression, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 4.75, fig.width = 10, fig.align = "center", fig.cap = "Comparison of simple linear regression and K-NN regression."}
set.seed(1234)
...
will underfit, meaning \index{underfitting!regression} that model/predicted values do not
...
if(!is_latex_output()){
  ...
  # save_image(plot_3d, "img/regression2/plot3d_linear_regression.png", scale = 10)
  knitr::include_graphics("img/regression2/plot3d_linear_regression.png")
}
```
...
```{r 08-lm-outlier, fig.height = 3.5, fig.width = 4.5, message = FALSE, warning = FALSE, echo = FALSE, fig.align = "center", fig.cap = "Scatter plot of a subset of the data, with outlier highlighted in red."}
...
```{r 08-lm-outlier-2, fig.height = 3.5, fig.width = 4.5, warning = FALSE, message = FALSE, echo = FALSE, fig.align = "center", fig.cap = "Scatter plot of the full data, with outlier highlighted in red."}
sacramento_outlier <- tibble(sqft = 5000, price = 50000)
...
```{r 08-lm-multicol, fig.height = 3.5, fig.width = 4.5, warning = FALSE, echo = FALSE, fig.align = "center", fig.cap = "Scatter plot of house size (in square feet) measured by person 1 versus house size (in square feet) measured by person 2."}
...
```{r 08-predictor-design, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Example of a data set with a nonlinear relationship between the predictor and the response."}
...
```{r 08-predictor-design-2, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Relationship between the transformed predictor and the response."}
