...
image_read("img/wrangling/data_frame_slides_cdn.004.png")
```
...
image_read("img/wrangling/data_frame_slides_cdn.005.png")
```
...
``` {r 02-vector, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Example of a vector whose type is character.", fig.retina = 2, out.width = "100%"}
image_read("img/wrangling/data_frame_slides_cdn.007.png")
```
...
``` {r 02-vec-vs-list, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "A vector versus a list.", fig.retina = 2, out.width = "100%"}
image_read("img/wrangling/data_frame_slides_cdn.008.png")
```
...
``` {r 02-dataframe, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Data frame and vector types.", fig.retina = 2, out.width = "100%"}
image_read("img/wrangling/data_frame_slides_cdn.009.png")
```
...
image_read("img/wrangling/tidy_data.001.png")
```
...
``` {r 02-wide-to-long, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Pivoting data from a wide to long data format.",  fig.retina = 2, out.width = "100%"}
knitr::include_graphics("img/wrangling/pivot_functions.001.png")
```
...
```{r img-pivot-longer-with-table, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "(ref:img-pivot-longer-with-table)", fig.retina = 2, out.width="100%"}
knitr::include_graphics("img/wrangling/pivot_functions.003.png")
```
...
``` {r img-pivot-longer, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "(ref:img-pivot-longer)", fig.retina = 2, out.width="100%"}
image_read("img/wrangling/pivot_longer.png") |>
...
``` {r long-to-wide, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Going from long to wide data.", fig.retina = 2, out.width = "100%"}
knitr::include_graphics("img/wrangling/pivot_functions.002.png")
```
...
``` {r img-pivot-wider-table, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "(ref:img-pivot-wider-table)", fig.retina = 2, out.width="100%"}
knitr::include_graphics("img/wrangling/pivot_functions.004.png")
```
...
``` {r img-pivot-wider, echo = FALSE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "(ref:img-pivot-wider)", fig.retina = 2, out.width="100%"}
image_read("img/wrangling/pivot_wider.png") |>
  image_crop("1625x850")
```
...
``` {r img-separate, echo = FALSE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "(ref:img-separate)", fig.retina = 2, out.width = "100%"}
image_read("img/wrangling/separate_function.png") |>
  image_crop("1625x1900")
```
...
``` {r img-mutate, echo = FALSE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "(ref:img-mutate)",  fig.retina = 2, out.width = "100%"}
image_read("img/wrangling/mutate_function.png") |>
  image_crop("1625x1900")
```
...
image_read("img/wrangling/summarize.001.png")
```
...
image_read("img/wrangling/summarize.003.png")
```
...
image_read("img/wrangling/summarize.005.png")
```
...
image_read("img/wrangling/summarize.004.png")
```
