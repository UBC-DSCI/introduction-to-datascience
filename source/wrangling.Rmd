...
image_read("img/wrangling/data_frame_slides_cdn.004.jpeg") %>%
  image_crop("3632x700")
```
...
image_read("img/wrangling/data_frame_slides_cdn.005.jpeg") %>%
  image_crop("3632x700")
```
...
image_read("img/wrangling/data_frame_slides_cdn.007.jpeg") %>%
  image_crop("3632x590")
```
...
image_read("img/wrangling/data_frame_slides_cdn.009.jpeg") %>%
  image_crop("3632x700")
```
...
knitr::include_graphics("img/wrangling/pivot_functions.001.jpeg")
```
...
image_read("img/wrangling/pivot_longer.jpeg") |>
...
knitr::include_graphics("img/wrangling/pivot_functions.002.jpeg")
```
...
image_read("img/wrangling/pivot_wider.jpeg") |>
  image_crop("1625x850")
```
...
image_read("img/wrangling/separate_function.jpeg") |>
  image_crop("1625x1900")
```
...
image_read("img/wrangling/mutate_function.jpeg") |>
  image_crop("1625x1900")
```
...
image_read("img/wrangling/summarize.001.jpeg") |>
...
image_read("img/wrangling/summarize.002.jpeg") |>
  image_crop("2000x475+0+300")
```
...
image_read("img/wrangling/summarize.003.jpeg") |>
  image_crop("2000x475+0+300")
```
...
image_read("img/wrangling/summarize.005.jpeg") |>
  image_crop("2000x475+0+300")
```
...
image_read("img/wrangling/summarize.004.jpeg") |>
  image_crop("2000x475+0+300")
```
