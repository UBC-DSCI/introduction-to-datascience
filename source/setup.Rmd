...
The worksheets can be run directly from that page,
or downloaded to your computer as a compressed zip folder.
Once you unzip the downloaded file, you can open the folder and 
run each worksheet using Jupyter. See Chapter \@ref(getting-started-with-jupyter) for
instructions on how to use Jupyter.
