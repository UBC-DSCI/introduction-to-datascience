...
```{r 11-example-proportions7, echo = TRUE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "Sampling distribution of the sample proportion for sample size 40.", fig.height = 3.3, fig.width = 4.2}
...
```{r 11-example-means2, echo = TRUE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "Population distribution of price per night (dollars) for all Airbnb listings in Vancouver, Canada.", fig.height = 3.5, fig.width = 4.5}
...
```{r 11-example-means-sample-hist, echo = TRUE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "Distribution of price per night (dollars) for sample of 40 Airbnb listings.", fig.height = 3.5, fig.width = 4.5}
...
```{r 11-example-means4, echo = TRUE, message = FALSE, fig.pos = "H", out.extra="", warning = FALSE, fig.align = "center", fig.cap= "Sampling distribution of the sample means for sample size of 40.", fig.height = 3.5, fig.width = 4.5}
sample_estimates <- samples |>
  group_by(replicate) |>
  summarize(mean_price = mean(price))
...
```{r 11-example-means5, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 5.5, fig.width = 4, fig.align = "center", fig.cap = "Comparison of population distribution, sample distribution, and sampling distribution."}
...
```{r 11-example-means7,  echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Comparison of sampling distributions, with mean highlighted as a vertical dashed line."}
...
```{r 11-example-bootstrapping0, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 6.8, fig.align = "center", fig.cap = "Comparison of samples of different sizes from the population."}
sample_10 <- airbnb |>
  rep_sample_n(10)
...
```{r 11-intro-bootstrap-image, echo = FALSE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "Overview of the bootstrap process.", fig.retina = 2, out.width="100%"}
...
```{r 11-bootstrapping1, echo = TRUE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "Histogram of price per night (dollars) for one sample of size 40.", fig.height = 3.5, fig.width = 4.5}
one_sample
...
```{r 11-bootstrapping3, echo = TRUE, message = FALSE, fig.pos = "H", out.extra="", warning = FALSE, fig.align = "center", fig.cap = "Bootstrap distribution.", fig.height = 3.5, fig.width = 4.5}
boot1 <- one_sample |>
...
```{r 11-bootstrapping5, echo = TRUE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra="", fig.align = "center", fig.cap = "Distribution of the bootstrap sample means.", fig.height = 3.5, fig.width = 4.5}
...
```{r 11-bootstrapping6, echo = F, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Comparison of the distribution of the bootstrap sample means and sampling distribution.", fig.height = 3.5}
samples <- rep_sample_n(airbnb, size = 40, reps = 20000)
...
```{r 11-bootstrapping7, echo = F, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Summary of bootstrapping process."}
...
```{r 11-bootstrapping9, echo = F, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Distribution of the bootstrap sample means with percentile lower and upper bounds.", fig.height=4, fig.width = 6.5}
boot_est_dist +
