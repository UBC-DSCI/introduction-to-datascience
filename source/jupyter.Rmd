...
```{r img-jupyter, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "A screenshot of a Jupyter Notebook.", fig.retina = 2, out.width="100%"}
knitr::include_graphics("img/jupyter/jupyter.png")
```
...
```{r code-cell-not-run, echo = FALSE, fig.align = "center", fig.cap = "A code cell in Jupyter that has not yet been executed.", fig.retina = 2, out.width="100%"}
image_read("img/jupyter/code-cell-not-run.png") |>
  image_crop("3632x1000")
```

```{r code-cell-run, echo = FALSE, fig.align = "center", fig.cap = "A code cell in Jupyter that has been executed.", fig.retina = 2, out.width="100%"}
...
```{r activate-and-run-button, echo = FALSE, fig.align = "center", fig.cap = "An activated cell that is ready to be run. The blue rectangle to the cell's left (annotated by a red arrow) indicates that it is ready to be run. The cell can be run by clicking the run button (circled in red).", fig.retina = 2, out.width="100%"}
...
3. Click the (`r fast_forward()`) button in the tool bar.
...
```{r restart-kernel-run-all, echo = FALSE, fig.align = "center", fig.cap = "Restarting the R session can be accomplished by clicking Restart Kernel and Run All Cells...", fig.retina = 2, out.width="100%"}
...
```{r create-new-code-cell, echo = FALSE, fig.align = "center", fig.cap = "New cells can be created by clicking the + button, and are by default code cells.", fig.retina = 2, out.width="100%"}
...
```{r markdown-cell-not-run, echo = FALSE, fig.align = "center", fig.cap = "A Markdown cell in Jupyter that has not yet been rendered and can be edited.", fig.retina = 2, out.width="100%"}
image_read("img/jupyter/markdown-cell-not-run.png") |>
  image_crop("3632x900")
```

```{r markdown-cell-run, echo = FALSE, fig.align = "center", fig.cap = "A Markdown cell in Jupyter that has been rendered and exhibits rich text formatting. ", fig.retina = 2, out.width="100%"}
...
```{r convert-to-markdown-cell, echo = FALSE, fig.align = "center", fig.cap = "New cells are by default code cells. To create Markdown cells, the cell format must be changed.", fig.retina = 2, out.width="100%"}
...
```{r out-of-order-1, echo = FALSE, fig.align = "center", fig.cap = "Code that was written out of order, but not yet executed.", fig.retina = 2, out.width="100%"}
image_read("img/jupyter/out-of-order-1.png") |>
  image_crop("3632x800")
```

```{r out-of-order-2, echo = FALSE, fig.align = "center", fig.cap = "Code that was written out of order, and was executed using the run button in a nonlinear order without error. The order of execution can be traced by following the numbers to the left of the code cells; their order indicates the order in which the cells were executed.", fig.retina = 2, out.width="100%"}
...
```{r out-of-order-3, echo = FALSE, fig.align = "center", fig.cap = '(ref:out-of-order-3)', fig.retina = 2, out.width="100%"}
...
```{r open-data-w-editor-1, echo = FALSE, fig.align = "center", fig.cap = "Opening data files with an editor in Jupyter.", fig.retina = 2, out.width="100%"}
image_read("img/jupyter/open_data_w_editor_01.png") |>
  image_crop("3632x2000")
```

```{r open-data-w-editor-2, echo = FALSE, fig.align = "center", fig.cap = "A data file as viewed in an editor in Jupyter.", fig.retina = 2, out.width="100%"}
...
```{r launcher, echo = FALSE, fig.align = "center", fig.cap = "Clicking on the R icon under the Notebook heading will create a new Jupyter notebook with an R kernel.", fig.retina = 2, out.width="100%"}
