...
```{r welcome, child='source/welcome.Rmd', eval=knitr::is_html_output()}
```

```{r foreword, child="source/foreword.Rmd"}
```

```{r preface, child="source/preface.Rmd"}
```

```{r acknowledgements, child="source/acknowledgements.Rmd"}
```
