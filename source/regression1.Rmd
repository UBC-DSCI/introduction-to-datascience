...
```{r 07-edaRegr, message = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Scatter plot of price (USD) versus house size (square feet)."}
...
```{r 07-small-eda-regr, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Scatter plot of price (USD) versus house size (square feet) with vertical line indicating 2,000 square feet on x-axis."}
...
```{r 07-knn3-example, echo = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Scatter plot of price (USD) versus house size (square feet) with lines to 5 nearest neighbors (highlighted in orange)."}
...
```{r 07-predictedViz-knn, echo = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Scatter plot of price (USD) versus house size (square feet) with predicted price for a 2,000 square-foot house based on 5 nearest neighbors represented as a red dot."}
nn_plot +
...
```{r 07-verticalerrors, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.cap = "Scatter plot of price (USD) versus house size (square feet) with example predictions (blue line) and the error in those predictions compared with true response values (vertical lines).", fig.height = 3.5, fig.width = 4.5}
# save the seed
seedval <- .Random.seed
...
```{r 07-choose-k-knn, results = FALSE, message=FALSE, echo = TRUE}
...
```{r 07-choose-k-knn-plot, echo = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Effect of the number of neighbors on the RMSPE."}
...
```{r 07-howK, echo = FALSE, warning = FALSE, fig.height = 13, fig.width = 10, fig.align = "center", fig.cap = "Predicted values for house price (represented as a blue line) from K-NN regression models for six different values for $K$."}
...
```{r 07-predict-all, warning = FALSE, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Predicted values of house price (blue line) for the final K-NN regression model."}
...
```{r 07-bedscatter, fig.height = 3.5, fig.width = 4.5, fig.align = "center", fig.cap = "Scatter plot of the sale price of houses versus the number of bedrooms."}
...
if(!is_latex_output()){
  ...
  # save_image(plot_3d, "img/regression1/plot3d_knn_regression.png", scale = 10)
  knitr::include_graphics("img/regression1/plot3d_knn_regression.png")
}
```
