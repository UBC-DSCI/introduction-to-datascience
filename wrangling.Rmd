...
We can also write the same sequence of functions with the data frame outside of the first function and we get the same result: 
```{r}
...
does this mean you should *never* store intermediate objects? Not necessarily! There are times when you will still want to store intermediate objects. For example, 
...
## Iterating data using `purrr`'s `map*` functions 
