...
a data frame is a special type of object in R whose columns are vectors. 
In particular, 
...
and vector elements must be of the same data type, 
...
but the elements are the same data type within each column. 
...
> to order the dataframe rows by the values in that column, in ascending order.
