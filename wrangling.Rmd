...
A data frame \index{data frame} is a table-like structure for storing data in R.  Data frames are
...
Now that our `tidy_lang` data is indeed *tidy*, we can start manipulating it
