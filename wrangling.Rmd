...
find the answer, perhaps by finding the maximum of each of our five columns first 
then finding the maximum of those. Though, it would be much easier to answer if we tidy our
data first. If mother tongue were instead stored as one column, we could simply 
use `max(mother_tongue)` to get the maximum number. 
