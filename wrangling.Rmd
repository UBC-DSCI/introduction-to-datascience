...
primary language at home is spoken by  `r format(lang_summary_max$most_most_at_home[1], scientific = FALSE, big.mark = ",")` people and at work is spoken by  `r format(lang_summary_max$most_most_at_work[1], scientific = FALSE, big.mark = ",")` people. 
