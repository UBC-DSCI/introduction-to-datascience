...
known as *multivariate linear regression*. \index{regression!multivariate linear}\index{regression!multivariate linear equation|see{plane equation}}
...
We will demonstrate multivariate linear regression using the Sacramento real estate  \index{Sacramento real estate}
...
We obtain an RMSPE \index{RMSPE} for the multivariate linear regression model 
...
What can go wrong when performing (possibly multivariate) linear regression? 
...
The second, and much more subtle, issue can occur when performing multivariate
