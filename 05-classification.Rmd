...
we define our own colourblind friendly palette using hexadecimal 
colour codes&mdash;`E69F00` for orange and `56B4E9` for light blue&mdash;and
...
We will use the cancer data set from above, using
