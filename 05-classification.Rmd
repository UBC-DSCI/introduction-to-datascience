...
created by Dr. William H. Wolberg, W. Nick Street, and Olvi L. Mangasarian at the University of Wisconsin, Madison. Each row in the data set represents an 
observation of a tumour cell nucleus, including the diagnosis (benign or malignant) and several other measurements 
(e.g., nucleus texture, perimeter, area, etc.). Diagnosis of each cell was conducted by physicians. 

As with all data analyses, we first need to formulate a precise question that we want to answer. Here, the question is of a *predictive* nature: can 
we use some, or all, of the measurements available to us about the tumour cells to do a good job of predicting whether a future tumour cell (with unknown diagnosis)
is benign or malignant? Answering this question is important because traditional, non-data-driven methods for tumour diagnosis are quite subjective and 
...
and accurately diagnose the tumour type to guide patient treatment protocols.
...
### Two explanatory variables / features / predictors
...
### More than two explanatory variables / features / predictors
