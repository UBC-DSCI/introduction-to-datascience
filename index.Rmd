...
We map each of these methods to the broader data analysis question, listed in Table \@ref(tab:questions-table), they help answer and discuss what kinds of data are needed to answer such questions [@leek2015question; @peng2015art]. More advanced data analysis questions in Table \@ref(tab:questions-table) (*e.g.,* causal or mechanistic) are beyond the scope of this book.
...
> This has several benefits that we'll discuss in further detail later in the book.
