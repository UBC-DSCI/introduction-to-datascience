...
This chapter provides an introduction to the R programming language. We will learn about some fundamental R topics and then go through an entire data analysis task! We will see how to read, clean, wrangle, and visualize some data to answer a specific question at a high level. Later in the book, we will learn each of these steps in more detail, but let's jump in now to see how much we can do with data science!
...
`tidyverse` contains many functions, which allow us to read, clean, wrangle and visualize data. 
