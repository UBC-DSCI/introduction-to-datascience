...
```{r}
spanish <- filter(can_lang, language == "Spanish")
spanish
```
...
```{r}
ggplot(spoke_often_at_home, aes(x = language, y = most_at_home)) +
...
ggplot(spoke_often_at_home, aes(x = language, y = most_at_home)) +
  geom_bar(stat = "identity") + 
   xlab("Language") + 
   ylab("Number of Canadians reporting their primary language at home")
```
...
ggplot(spoke_often_at_home, aes(x = language, y = most_at_home)) +
  geom_bar(stat = "identity") + 
   xlab("Language") +  
   scale_y_continuous(name = "Number of Canadians reporting their primary language at home",
                      labels = scales::comma
)
```
