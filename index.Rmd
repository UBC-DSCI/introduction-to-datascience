...
Tables in Microsoft Excel are an example of *tablular data*, which are rectangular-shaped, spreadsheet-like data as shown in Figure \@ref(fig:img-spreadsheet-vs-dataframe).
