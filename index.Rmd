...
Let's now use the assignment symbol to name the US state-level property, income, population and voting data frame, that we get from `read_csv`, `prop_data`.

```{r load data with name}
prop_data <- read_csv("state_property_vote.csv")
```
