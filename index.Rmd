...
including the `ggplot` function that we will use shortly for our visualization. 
...
(not fuzzy) we can say that the relationship is strong. Because drawing a straight line through these 
