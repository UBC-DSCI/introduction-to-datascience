...
<iframe style="margin:0 auto; min-width: 100%;" id="myIframe1" class="interactive" src="https://ttimbers.shinyapps.io/test/" scrolling="no" frameborder="no"></iframe>
...
<script>
  iFrameResize({heightCalculationMethod:'taggedElement'}, ".interactive");
</script>