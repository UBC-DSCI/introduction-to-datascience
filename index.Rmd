...
This is an open source textbook aimed at introducing undergraduate students to Data Science. It was originally written for the University of British Columbia's [DSCI 100 - Introduction to Data Science](https://ubc-dsci.github.io/dsci-100/) course. In this book, we define data science as the processes used to obtain value (i.e., insight) from data through reproducible and auditable processes. 
...
However, the best way to learn how to write and run code and formattable text in a Jupyter notebook is to do it yourself! [Here is a worksheet](https://github.com/UBC-DSCI/dsci-100-assets/blob/master/materials/worksheet_01/worksheet_01.ipynb) that provides a step-by-step guide through the basics.
...
two variables do this, we call this a *positive relationship*. Because of the data point in the lower left-hand corner, drawing a straight line through these 
points wouldn't fit very well. When a straight-line doesn't fit the data well we say that it's non-linear. Because the increasing pattern is fairly clear 
(not fuzzy) we can say that the relationship is strong. 
