...
scatter plot to represent the higher level language category each language belongs to. 
...
What do we see when considering the second part of our exploratory question? Do we see a pattern in the relationship between the number of people who speak a language as their mother tongue and the number of people who speak a language as their primary spoken language at home for the different higher-level language categories? Probably not! 
...
Does this mean that the relationship between the number of people who speak a language as their mother tongue and the number of people who speak a language as their primary spoken language at home is positive for all languages in the world? Or could we use this data visualization on its own to predict how many people have a given language as their mother tongue if we know how many people speak it as their primarly language at home?
