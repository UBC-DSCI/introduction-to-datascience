...
morley_hist2 <- ggplot(morley, aes(x = Speed, fill= Expt)) + geom_histogram(position='identity', alpha=0.2)  + scale_fill_manual(values=c("red", "blue", "green", "yellow", "gray70"))
ggplot(morley, aes(x=Speed, color=factor(Expt), fill=factor(Expt))) + geom_histogram(alpha=0.5, position='identity')
