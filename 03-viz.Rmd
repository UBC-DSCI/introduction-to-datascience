...
**Question:** Is there a relationship between the waiting time before an eruption to the duration of the eruption? Also, would it be possible to use the current time since
