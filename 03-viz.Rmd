...
The purpose of a visualization is to answer a question about a dataset of interest. So naturally, the first thing to do **before** creating 
...
to the true value. There is a similar geometric object, `geom_hline`, that is used for plotting horizontal lines. Note that *vertical lines*
