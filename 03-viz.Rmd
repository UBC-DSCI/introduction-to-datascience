...
records the atmospheric concentration of carbon dioxide (CO2, in parts per million) at the Mauna Loa research station in Hawaii from 1959 onwards [@maunadata].
...
We will return to the `can_lang` data set [@timbers2020canlang], which contains counts of languages from the 2016 Canadian census.
