...
- **Vector / Scalable Graphics**: image is represented as a collection of mathematical objects (lines, planes, shapes, curves). When the computer displays the image, it redraws all of the elements using their mathematical formulas.
    - *common file types:* PDF (`.pdf`) and SVG (`.svg`), both for general purpose use
...
what the image shows (caveat: the compression algorithms may be better / faster for certain images). A vector image takes space and time to load 
