...
- Do not use pie charts (its harder for us to compare the sizes of the slices of a pie, than it is to compare sizes of bars).
- Do not use 3D (we don't see in 3D, not even as we're walking around in space)
- Don't ever use tables *humans are
way better at processing and understanding images than text and math*.
