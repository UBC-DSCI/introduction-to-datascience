...
- The [tidyverse website](https://tidyverse.org) has [a page on `dplyr`](https://dplyr.tidyverse.org/) that contains a very nice cheat sheet that summarizes a lot of the data wrangling functions from this chapter.
