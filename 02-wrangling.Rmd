...
- The [`dplyr` page on the tidyverse website](https://dplyr.tidyverse.org/) contains a very nice cheat sheet that summarizes a lot of the data wrangling functions from this chapter.
