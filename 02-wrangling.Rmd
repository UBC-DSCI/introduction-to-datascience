...
ggplot(official_langs, aes(x = region, y = most_at_work, fill = language)) +
  ...
  scale_color_manual(values = c("deepskyblue2","firebrick1")) + # choose point colours
  ...
  xlab("Region") + 
  coord_flip() +
  ggtitle("Official languages spoken most often at home for five major Canadian cities") +
  theme_bw()
```
