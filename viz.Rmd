...
Recall [the different data analysis questions](index.html#chapter-learning-objectives) from Chapter \@ref(intro). With the visualizations
...
and in each experiment 20 runs were performed - 
meaning that 20 measurements of the speed of light were collected 
...
We convert it to a tibble to take advantage of the nicer print output 
these specialized data frames provide.
An additional thing to know about this data set, 
is that because the speed of light is a very large number 
