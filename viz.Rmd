...
```{r 03-ggplot-function-scatter, echo=FALSE, fig.cap = "Creating a scatter plot with the ggplot function.", message =F, out.width="100%"}
...
```{r 03-mother-tongue-vs-most-at-home, fig.width=4.25, fig.height=3.5, warning=FALSE, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home."}
...
```{r 03-mother-tongue-vs-most-at-home-labs, fig.width=4.25, fig.height=3.5, warning=FALSE, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home with x and y labels."}
ggplot(can_lang, aes(x = most_at_home, y = mother_tongue)) +
  geom_point() +
...
```{r 03-mother-tongue-vs-most-at-home-scale, message = FALSE, warning =  FALSE, fig.width=4.25, fig.height=3.5, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home with log adjusted x and y axes."}
library(scales)
...
```{r 03-mother-tongue-vs-most-at-home-scale-props, fig.width=4.25, fig.height=3.5, warning=FALSE, fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home."}
...
```{r 03-scatter-color-by-category, warning=FALSE, fig.height=3.5, fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home colored by language category with the legend edited."}
...
is overly long and redundant, and takes up valuable plot area. 
We can improve this by changing the legend title 
and legend category text to be shorter, and less redundant.
To change the title, we set `color = "Language category"` in the `labs` function.
To change the legend category text, we use the `scale_color_discrete` function.
The `scale_color_discrete` function `labels` argument 
takes a character vector of new category labels. 
We change these to `"Aboriginal"`, `"Other"`, and `"Official"`.

```{r 03-scatter-color-by-category-legend-edit, warning=FALSE, fig.height=3.5, fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home colored by language category with the legend edited."}
ggplot(can_lang, aes(x = most_at_home_percent, 
                     y = mother_tongue_percent, 
                     color = category)) +
  geom_point() +
  ...
  scale_x_log10(labels = comma) +
  scale_y_log10(labels = comma) +
  scale_color_discrete(labels = c("Aboriginal", 
                                "Other",
                                "Official"))
```
...
```{r rcolorbrewer, fig.height = 8, fig.cap = "Color palettes available from the `RColorBrewer` R package."}
...
```{r scatter-color-by-category-palette, fig.height=3.5, warning=FALSE,  fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home colored by language category with color-blind friendly colors."}
ggplot(can_lang, aes(x = most_at_home_percent, 
                     y = mother_tongue_percent, 
                     color = category, 
                     shape = category)) +
...
```{r 03-raster-image, echo=FALSE, fig.cap = "Zoomed in `faithful`, raster (PNG, left) and vector (SVG, right) formats.", fig.show="hold", out.width="100%", out.height="200pt", fig.align= "center", message =F}
