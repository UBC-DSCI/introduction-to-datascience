...
graphics](https://serialmentor.com/dataviz/directory-of-visualizations.html)
available to use. The types of plot that we introduce in this book 
are shown in Figure \@ref(fig:plot-sketches);
...
```{r plot-sketches, echo = FALSE, out.width="100%", fig.align = 'center', fig.cap = "Examples of scatter, line and bar plots, as well as histograms."}
set.seed(1)
...
- Make sure to use color schemes that are understandable by those with
  colorblindness (a surprisingly large fraction of the overall population).
  For example, [colorbrewer.org](https://colorbrewer2.org) and the `RColorBrewer`
  R package provide the ability to pick such color schemes, and you can check
  your visualizations after you have created them by uploading to online tools
  such as the [color blindness simulator](https://www.color-blindness.com/coblis-color-blindness-simulator/).
...
```{r 03-data-co2-scatter, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Scatter plot of atmospheric concentration of CO$_{2}$ over time."}
...
```{r 03-data-co2-line, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Line plot of atmospheric concentration of CO$_{2}$ over time."}
...
```{r 03-data-co2-line-2, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Line plot of atmospheric concentration of CO$_{2}$ over time with clearer axes and labels."}
co2_line <- ggplot(co2_df, aes(x = date_measured, y = ppm)) +
  geom_line() +
  xlab("Year") +
...
```{r 03-data-co2-line-3, warning = FALSE, message = FALSE, out.width = "100%", fig.cap = "Line plot of atmospheric concentration of CO$_{2}$ from 1990 to 1994."}
library(lubridate)
...
```{r 03-data-faithful-scatter, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Scatter plot of waiting time and eruption time."}
...
```{r 03-data-faithful-scatter-2, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Scatter plot of waiting time and eruption time with clearer axes and labels."}
faithful_scatter <- ggplot(faithful, aes(x = waiting, y = eruptions)) +
  geom_point() +
...
```{r 03-mother-tongue-vs-most-at-home, out.width = "100%", warning=FALSE, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home."}
...
```{r 03-mother-tongue-vs-most-at-home-labs, out.width = "100%", warning=FALSE, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home with x and y labels."}
ggplot(can_lang, aes(x = most_at_home, y = mother_tongue)) +
  geom_point() +
...
```{r 03-mother-tongue-vs-most-at-home-scale, message = FALSE, warning =  FALSE, out.width = "100%", fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home with log adjusted x and y axes."}
library(scales)
...
```{r 03-mother-tongue-vs-most-at-home-scale-props, out.width = "100%", warning=FALSE, fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home."}
...
```{r 03-scatter-color-by-category, warning=FALSE, out.width = "100%", fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home colored by language category."}
...
```{r 03-scatter-color-by-category-legend-edit, warning=FALSE, out.width = "100%", fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home colored by language category with the legend edited."}
ggplot(can_lang, aes(x = most_at_home_percent, 
                     y = mother_tongue_percent, 
                     color = category)) +
  geom_point() +
...
colors? In R, one package that provides alternative color 
palettes \index{color palette} is `RColorBrewer` [@RColorBrewer]. You can 
visualize the list of color
...
```{r rcolorbrewer, fig.height = 8, fig.cap = "(ref:rcolorbrewer)"}
...
Additionally, the `ggthemes` R package also has a [color-blind friendly color palette](https://jrnold.github.io/ggthemes/reference/colorblind.html).
...
```{r scatter-color-by-category-palette, out.width = "100%", warning=FALSE,  fig.cap = "Scatter plot of percentage of Canadians reporting a language as their mother tongue vs the primary language at home colored by language category with color-blind friendly colors."}
ggplot(can_lang, aes(x = most_at_home_percent, 
                     y = mother_tongue_percent, 
                     color = category, 
                     shape = category)) +
...
```{r 03-data-islands-bar, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Bar plot of all Earth's landmasses' size with squished labels."}
...
```{r 03-data-islands-bar-2, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Bar plot of size for Earth's largest 12 landmasses."}
...
```{r 03-data-islands-bar-4, warning = FALSE, message = FALSE, out.width = "100%", fig.cap = "Bar plot of size for Earth's largest 12 landmasses colored by whether its a continent with clearer axes and labels."}
...
```{r 03-data-morley-hist, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Histogram of Michelson's speed of light data."}
...
```{r 03-data-morley-hist-2, warning=FALSE, message=FALSE,out.width = "100%", fig.cap = "Histogram of Michelson's speed of light data with vertical line indicating true speed of light."}
morley_hist <- ggplot(morley, aes(x = Speed)) +
  geom_histogram() +
...
```{r 03-data-morley-hist-3, warning=FALSE, message=FALSE, out.width = "100%", fig.cap = "Histogram of Michelson's speed of light data colored by experiment."}
...
```{r 03-data-morley-hist-with-factor, warning=FALSE, message=FALSE, out.width = "100%",  fig.cap = "Histogram of Michelson's speed of light data colored by experiment as factor."}
...
multiple separate histogram plots arranged in a grid.
...
```{r 03-plot-line, collapse=TRUE, warning=FALSE, message=FALSE, out.width="100%", fig.cap = "Scatter plot of waiting time and eruption time."}
