...
```{r 06-precode, out.width = "100%", fig.cap="Scatter plot of tumor cell concavity versus smoothness colored by diagnosis label.", message = F, warning = F}
# load packages
library(tidyverse)
library(tidymodels)
...
```{r 06-find-k, out.width = "100%", fig.cap= "Plot of estimated accuracy versus the number of neighbors."}
...
```{r 06-lots-of-ks, message = FALSE, out.width = "100%", fig.cap="Plot of accuracy estimate versus number of neighbors for many K values."}
...
```{r 06-decision-grid-K, echo = FALSE, message = FALSE, out.width = "100%", fig.height = 10, fig.width=10, fig.cap = "Effect of K in overfitting and underfitting."}
ks <- c(1, 7, 20, 300)
plots <- list()
