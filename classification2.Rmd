...
We start by loading the necessary packages, reading in the breast cancer data
...
```{r 06-overview, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Overview of K-NN classification", fig.retina = 2, out.width = "660pt"}
...
the breast cancer data to have only the `Smoothness`, `Concavity`, and `Perimeter` variables from the original data. Then, we added irrelevant variables that we created ourselves using a random number generator.
...
```{r 06-neighbors-irrelevant-features, echo = FALSE, warning = FALSE, fig.retina = 2, out.width = "600pt", fig.cap = "Tuned number of neighbors for varying number of irrelevant predictors"}
...
```{r 06-fixed-irrelevant-features, echo = FALSE, warning = FALSE, fig.retina = 2, out.width = "600pt", fig.cap = "Accuracy versus number of irrelevant predictors for tuned and untuned number of neighbors"}
