...
with the [`rvest` R package](https://github.com/hadley/rvest) [@rvest]
...
[entire source code is available here](https://github.com/UBC-DSCI/introduction-to-datascience/blob/master/img/website_source.txt):
...
the [rtweet](https://github.com/ropensci/rtweet) [@rtweet] package in R
...
(see [the `rtweet` package](https://github.com/ropensci/rtweet) [@rtweet]
