...
Figure \@ref(11-population-vs-sample) illustrates this process.
...
```
In Figure \@ref(fig:11-example-means2), we see that the population distribution has one peak and is skewed (i.e. not symmetric) since most of the listings
...
The average value of the sample of size 40 is \$`r round(estimates$sample_mean, 2)`.
...
The process is visualized in Figure \@ref(fig:11-intro-bootstrap-image).
