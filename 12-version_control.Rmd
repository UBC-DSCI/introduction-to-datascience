...
here will will focus on how to use the Jupyter Git interface. 
...
that is ready for the intended audience. 
Without deliberate and conscious effort towards tracking changes 
made to the analysis, projects tend to become messy. This mess can include 
mystery results files that cannot be reproduced,
temporary files with snippets of ideas, 
mind-boggling filenames like `document_final_draft_v5_final.txt`,
large blocks of commented code "saved for later," and more. 
...
The version control system is the software that is responsible 
for tracking changes, sharing changes you make with others, 
obtaining changes others have made, and resolving conflicting edits.
...
> You can, for example, use Git to version control a project
...
your local computer, or using a JupyterHub; below we show how to do this using a 
JupyterHub.

We need to *clone* our project's Git repository to our JupyterHub---i.e., make a 
...
of the Code drop down menu on GitHub:
