...
It is interesting that we can use data visualization to uncover such patterns,
...
```{r 10-toy-example-clustering, echo = FALSE, warning = FALSE, fig.height = 4, fig.width = 5, fig.cap = "Scatter plot of standardized bill length versus standardized flipper length with coloured groups"}
...
This can work because both vector and lists are legitimate 
