...
```{r 10-clustering, warning = F, message=F}
library(tidyverse)
set.seed(1)
...
We begin the K-means \index{K-means!algorithm} algorithm by picking K, and uniformly randomly assigning data to the K clusters. 
...
and found a bad clustering! \index{K-means!restart,nstart} We can help prevent finding a bad clustering by trying a 
