...
*within-cluster sum-of-squared-distances*. Computing this involves two steps:
...
In the 3-observation cluster example above, we would compute the within-cluster sum-of-squared-distances
$S^2$ via
