...
``` {r img-read-csv, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Syntax for the read_csv function", out.width="1100pt", fig.retina = 2}
...
``` {r img-filter, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Syntax for the filter function", out.width="1100pt", fig.retina = 2}
...
``` {r img-select, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Syntax for the select function", out.width="1100pt", fig.retina = 2}
...
``` {r img-arrange, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Syntax for the arrange function", out.width="1100pt", fig.retina = 2}
