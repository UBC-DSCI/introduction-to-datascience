...
> examples to concentrate on fundamental concepts. In real life, you cannot and should not
> do data science without a domain expert. Alternatively, it is common to
> practice data science in your own domain of expertise! Remember that when you work
> with data, it is essential to think about *how* the data were collected,
> which affects the conclusions you can draw. If your data are biased, then your
...
Classification is covered in Chapters \@ref(classification) and \@ref(classification\_continued).
...
6. **Estimation:** taking a small number of items from a large group 
 and making a good guess for the average or proportion 
...
many different forms! Tables in Microsoft Excel are an example of perhaps
the most common form of data set: *tablular data*. Tabular data are
