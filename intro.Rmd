...
code: 
```{r 01-get-help, warning = FALSE, message = FALSE}
?filter
```
...
documentation like that in Figure \@ref(fig:01-help). But do keep in mind that the documentation
is not meant to *teach* you about a function. It is just there as a reference to *remind*
