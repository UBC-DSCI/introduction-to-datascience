...
```{r barplot-mother-tongue, out.width = "100%", warning=FALSE, fig.cap = "Bar plot of the ten Aboriginal languages most often reported by Canadians as their mother tongue."}
...
```{r barplot-mother-tongue-labs, out.width = "100%", warning=FALSE, fig.cap = "Bar plot of the ten Aboriginal languages most often reported by Canadians as their mother tongue with x and y labels."}
ggplot(ten_lang, aes(x = language, y = mother_tongue)) +
  geom_bar(stat = "identity") +
  xlab("Language") +
...
```{r barplot-mother-tongue-flipped, out.width = "100%", warning=FALSE, fig.cap = "Horizontal bar plot of the ten Aboriginal languages most often reported by Canadians as their mother tongue."}
...
```{r barplot-mother-tongue-reorder, out.width = "100%", warning=FALSE, fig.cap = "Bar plot of the ten Aboriginal languages most often reported by Canadians as their mother tongue with bars reordered."}
...
modifications. Particularly, we changed the color of the bars, and also actually skipped the
...
```{r nachos-to-cheesecake, out.width = "100%", warning=FALSE, message=FALSE, fig.cap = "Putting it all together: bar plot of the ten Aboriginal languages most often reported by Canadians as their mother tongue."}
library(tidyverse)
