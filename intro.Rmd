...
The way to assign a name to our data frame in R is via the *assignment symbol* `<-`.
...
Note that&mdash;unlike the file name `"data/can_lang.csv"` we specified before&mdash;when 
