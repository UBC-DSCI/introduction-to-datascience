...
To create a new code cell in Jupyter (Figure \@ref(fig:create-new-code-cell)), click the `+` button in the Jupyter 
...
(or *rendered*) text (Figure \@ref(fig:markdown-cell-run)), click the **Run** (▶) button in the Jupyter 
...
Teaching the markdown formatting 
