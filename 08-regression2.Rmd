...
```{r 08-lin-reg1, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 4, fig.width = 5, fig.cap = "Scatter plot of price versus house size with line of best fit for subset of the Sacramento housing data"}
library(tidyverse)
library(tidymodels)
library(scales)
library(gridExtra)
...
```{r 08-lin-reg2, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 4, fig.width = 5, fig.cap = "Scatter plot of price versus house size with line of best fit and a red dot at the predicted price for a 2000 square foot home"}
...
```{r 08-several-lines, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 4, fig.width = 5,  fig.cap = "Scatter plot of price versus house size with many possible lines that could be drawn through the data points"}
...
```{r 08-verticalDistToMin,  echo = FALSE, message = FALSE, warning = FALSE, fig.height = 4, fig.width = 5, fig.cap = "Scatter plot of price versus house size with red lines denoting the vertical distances between the predicted values and the observed data points"}
...
```{r 08-lm-predict-all, fig.height = 4, fig.width = 5, warning = FALSE, message = FALSE, fig.cap = "Scatter plot of price versus house size with line of best fit for the full Sacramento housing data"}
...
test data (here we compare test errors purely for the purposes of teaching).
...
if the only available predictor was "the current house owner's favourite icecream flavour",
...
the housing market and homeowner icecream preferences). In cases like these, 
...
will not be correctly captured by simple linear regression:
<center>
...
In this case, you can see that the transformed predictor `z` helps the 
linear regression model make more accurate predictions. The process of
