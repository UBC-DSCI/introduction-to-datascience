...
and regression---using K-nearest neighbours (K-NN)-based approaches. But while K-NN methods are 
...
as in the settings of multivariate K-NN regression and classification: more predictors is **not** always
...
and multivariate K-NN regression. If this comparison is part of 
