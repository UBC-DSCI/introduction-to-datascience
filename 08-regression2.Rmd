...
simple and flexible, in the context of regression there is another method (far more popular in
most scientific disciplines) known as *linear regression*. This chapter provides an introduction
to the concept of linear regression, shows how to use `tidymodels` to perform linear regression in R,
