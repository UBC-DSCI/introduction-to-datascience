...
and regression---using K-nearest neighbours (KNN)-based approaches. But while KNN methods are 
...
Back to the example! Once we have the coefficients, we can use the equation above to evaluate the predicted sale price given the value we
have for the predictor/explanatory variable&mdash;here 2,000 square feet. Figure \@ref(fig:08-lin-reg2)
...
`geom_smooth`. Figure \@ref(fig:08-lm-predict-all) displays the result.
