...
Once we have the coefficients, we can use the equation above to evaluate the predicted sale price given the value we
...
house sale price on this data set. But we should also ask if this more complex
