...
Let's construct a small data set of the last 400 tweets and retweets from the [Tidyverse account]((https://twitter.com/tidyverse?lang=en)). A few of the most recent tweets
are shown in Figure \@ref(fig:01-tidyverse-twitter).

```{r 01-tidyverse-twitter, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "The Tidyverse Twitter feed.", fig.retina = 2, out.width="100%"}
