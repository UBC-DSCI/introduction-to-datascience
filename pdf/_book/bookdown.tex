...
\hypersetup{
  ...
  pdfauthor={Tiffany-Anne Timbers},
  colorlinks=true,
  linkcolor={Maroon},
  filecolor={Maroon},
  citecolor={Blue},
...
\item
  \textbf{Estimation:} \index{estimation!overview} taking measurements for a small number of items from a large group
...
\caption{\label{fig:img-read-csv}Syntax for the read\_csv function}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/select_function} \caption{Syntax for the select function}\label{fig:img-select}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/arrange_function} \caption{Syntax for the arrange function}\label{fig:img-arrange}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/ggplot_function} \caption{Creating a bar plot with the ggplot function}\label{fig:img-ggplot}
\end{figure}
...
\caption{\label{fig:01-help}The documentation for the \texttt{filter} function, including a high-level description, a list of arguments and their meanings, and more.}
\end{figure}
