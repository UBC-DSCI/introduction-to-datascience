...
to trade off the desiderata to have a high accuracy, but also a simple model with few predictors (which has 
a lower chance of overfitting). The way to perform that trade-off is to look for the *elbow*
