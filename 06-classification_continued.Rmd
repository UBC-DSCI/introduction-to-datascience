...
does not do much better than the majority classifier that just always predicts "benign," 
...
number of total variables (i.e., at most 10) from which you want to keep only the relevant ones. 
Best subset selection works as follows. If you have $m$ predictors, you: 
