...
> We are using the function `glimpse` to view the data set. Since our data set contains many columns, `glimpse` outputs the data such that the columns go down the page, which allows us to see every column in the data frame.
