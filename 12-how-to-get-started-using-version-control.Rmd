...
version control, and GitHub for remote version control. There are many user 
interfaces for using Git, here will will focus on how to use the Jupyter Git 
interface. We will focus on the most common version control operations used 
day-to-day in a standard data science project. 
...
- Give co llaborators access to a GitHub repository
...
A newly created repository that was configured as being public and with a with a 
README.md template file should look something like this:
...
Git to keep a record of the current version, you need to *commit* 
(*i.e.*, snapshot) your changes. Then once you have made commits that you want 
to share with your collaborators, you need to *push* (i.e., send) those commits 
back to GitHub. Again, we can use the JupyterLab Git extension tool 
to do all of this. In particular, your workflow on JupyterHub should look like 
this:
