...
Now that we have taken 1000 samples, to create a sampling distribution of sample proportions for samples of size 40, we need to calculate the proportion of chocolate Timbits for each sample, $\hat{p_\text{chocolate}}$:
...
```
Now that we have calculated the proportion of chocolate Timbits for each sample, $\hat{p_\text{chocolate}}$, we can visualize the sampling distribution of sample proportions for samples of size 40:
