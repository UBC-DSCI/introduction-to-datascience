...
grid.arrange(
  ...
  # n = 50          
   sampling_distribution_50 + 
    ...
    xlim(80, 260) + 
    annotate("text", x = max_x(sampling_distribution_50), y= max_count(sampling_distribution_50), hjust = 1, vjust = 1,
             label = paste("mean = ", round(mean(sample_estimates_50$sample_mean), 1)))+
    annotate("text", x =  max_x(sampling_distribution_50), y = max_count(sampling_distribution_50), hjust = 1, vjust = 3,
  ...
  sampling_distribution_100 + 
    ...
    xlim(80, 250) + 
    annotate("text", x =  max_x(sampling_distribution_100), y = max_count(sampling_distribution_100), hjust = 1, vjust = 1,
             label = paste("mean = ", round(mean(sample_estimates_100$sample_mean), 1)))+
    annotate("text", x =  max_x(sampling_distribution_100), y = max_count(sampling_distribution_100), hjust = 1, vjust = 3,
