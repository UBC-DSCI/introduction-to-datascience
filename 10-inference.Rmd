...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Comparision of population distribution and sampling distributions for sizes 20, 50 and 100"}
...
grid.arrange(annotated_population, annotated_sampling_dist_20, annotated_sampling_dist_50, annotated_sampling_dist_100,  nrow = 2, ncol = 2) 
```
...
bootstrap_dist <- boot_est_dist+ ggtitle("Bootstrap distribution") + xlab("Sample means") + 
    theme(axis.ticks.x = element_blank(),
        axis.text.x = element_blank(), 
        axis.title.y =element_blank(), 
        axis.ticks.y = element_blank(),
