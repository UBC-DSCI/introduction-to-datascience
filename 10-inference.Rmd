...
## Overview
Recall from Chapter 1, one of the data analysis questions we often want to answer is an *inferential question* where we make conclusions about a population of interest based on observed data sampled from that population. Statistical inference can help us decide if differences we observe between the responses of two groups in say a clinical trial give us evidence that these differences exist in the wider population.

We will start with fundamental ideas of sampling, populations, samples, parameters and statistics and work our way to discussing sampling distributions, bootstrapping, estimation and confidence intervals. In this chapter we will introduce two forms of statistical inference: 

* Point Estimation 
* Interval Estimation

Point estimation and interval estimate are two methods of drawing conclusions about the population using our sample, however there are other inference methods which we will not discuss in this chapter. The term "statistical inference" encompasses a wide range of methods and there are many complexities for performing inference, however, this chapter will provide you with a broad introduction to sampling and statistical inference. 
...
Statistical inference is a data analysis question where we want to look for patterns, trends, or relationships in a data set and decide how applicable these findings are to the wider population.	For example, we might use statistical inference to help us answer the questions:

* What is the average price of all one bedroom apartments in Vancouver, Canada?
or
* What proportion of all University of British Columbia undergraduate students have an iPhone?

In these questions we are interested in making conclusions about all one bedroom apartments in Vancouver, Canada and all University of British Columbia undergraduate students respectively, which represent our populations of interest. A **population** is the complete collection of individuals, or cases we are interested in studying. A census would provide all of the characteristics about the population. However, in practice, a census is often time consuming, costly and sometimes impossible. Therefore we can take a **sample**, a subset of individuals, or cases collected from the population. A sample can provide useful information about the population if the sample is *unbiased*. A sample is said to be biased if the sample is systematically different from the population in some way. 
A parameter is a numerical characteristic of the population and a statistic is a numerical characteristic of the sample. In the first question, the population parameter that we infer about is the population mean, the average price of all one bedroom apartments in Vancouver, Canada. The proportion of University of British Columbia undergraduate students have an iPhone, is another population parameter, specifically the population proportion. These questions are examples of *point estimation*, where we estimate our population parameter using a single value. We may choose a sample from our populations and use the observed data to make an inference about the proportion of all University of British Columbia undergraduate students that have an iPhone.
