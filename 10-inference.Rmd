...
## Overview
Recall from Chapter 1, one of the data analysis questions we often want to answer is an *inferential question* where we make conclusions about a population of interest based on observed data sampled from that population. For example, statistical inference can help us decide if differences we observe between the responses of two groups in a clinical trial give us evidence that these differences exist in the wider population.
