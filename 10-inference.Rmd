...
So what can we learn from this sampling distribution? This distribution tells us what we might expect from proportions from samples of size $40$ when our population proportion is 0.63. If we can somehow learn what the sampling distribution looks like, we can use it to make inferences about our population when only having a single sample.  
...
```{r 11-example-means3, echo = TRUE, message = FALSE, warning = FALSE, fig.cap = "Distribution of price per night ($) for sample of 20 Airbnb listings", out.width = "50%"}
sample_1 <- airbnb %>% 
    rep_sample_n(20)
head(sample_1)
