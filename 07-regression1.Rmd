...
What about the plot in Figure \@ref(fig:07-howK) where $K$ is quite large, 
say, $K$ = 250 or 932? 
...
size), depend on many neighbouring observations. 
...
we can see it has a lower training data error than our model with a very high $K$ (e.g., 932),
