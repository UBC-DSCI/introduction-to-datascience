...
of our method on observations not seen during training; and we can use cross-validation to evaluate different
...
In this chapter and the next, we will study the Sacramento real estate data set. This data set contains 932 real estate transactions in Sacramento, California from a five day period [originally reported in the Sacramento Bee newspaper](https://support.spatialkey.com/spatialkey-sample-csv-data/),
