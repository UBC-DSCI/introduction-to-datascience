...
file whose changes we would like to commit), we click the JupyterLab git extension 
...
This opens the JupyterLab Git graphical user interface pane, and then we
