...
We will be using a Jupyter lab git extension tool to bring our 
[GitHub.com](https://github.com/) project repository to the UBC JupyterHub. 
...
Once you make changes (e.g., create or edit files) in your project repository on 
JupyterHub, you will need to send them back to the project repository on 
[GitHub.com](https://github.com/) to be able to share these with your 
...
repository on [GitHub.com](https://github.com/).
...
JupyterHub) to the project repository on [GitHub.com](https://github.com/)
...
like to send back to the project repository on [GitHub.com](https://github.com/). 
...
plus sign beside the file that we want to "add". Note, because this is the 
...
directly created and edited to [GitHub.com](https://github.com/).
...
are ready to now "commit" the changes to log them and associate a (useful) 
...
This is especially useful when you want to go back in time to checkout an older
version of a file, or state of the project.
...
[GitHub.com](https://github.com/), we need to "Push" them. To do this we click on 
...
If you now go to the project repository on [GitHub.com](https://github.com/) you 
...
### Pulling changes from [GitHub.com](https://github.com/)
...
do this using the Git GUI pane by clicking on the cloud icon with the down arrow:
