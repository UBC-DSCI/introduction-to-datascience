...
1. Enter the name for your project repository. In the example below, we use `languages_in_canada`. Most repositories follow this naming convention, which involves lowercase letter words separated by either underscores or hyphens.
...
Again, we can use the JupyterHub Git extension tool 
...
5. When you want to share your commits (that only exist in your cloned repository right now) with your collaborators, you *push* them
back to the hosted repository on GitHub.


Below we walk through how to use the JupyterHub Git extension tool to do 
