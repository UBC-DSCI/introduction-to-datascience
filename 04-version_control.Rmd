...
```{r setup_version_control, echo = FALSE, message = FALSE, warning = FALSE}
library(knitr)
library(magrittr)
library(magick)
...
image_read("img/version_control/new_repository_01.png") %>% 
  ...
  image_flop() #%>% 
  #image_shadow() %>% 
  #image_resize(geometry_size_pixels(height = 1700))
```
...
```{r git_commit_03}
include_graphics("img/version_control/git_commit_03.png")
```
