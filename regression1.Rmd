...
regression with more than one predictor variable, i.e., *multivariate regression*.
...
We will now demonstrate a multivariate KNN regression \index{K-nearest neighbors!multivariate regression} analysis of the 
...
Regardless, let's continue the analysis to see how we can make predictions with a multivariate KNN regression model
