...
Now we will learn more about reading tabular data from a plain text file (a document containing only text) into R, as well as how to write tabular data to a file. 
