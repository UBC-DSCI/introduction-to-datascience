...
- The [`readr` page on the tidyverse website](https://readr.tidyverse.org/) contains a very nice cheat sheet that summarizes a lot of the reading and writing functions from this chapter.
