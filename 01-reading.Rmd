...
Another very common form of data storage to be read into R for the purpose of data analysis is the relational database. Common database software you might encounter include 
SQLite, MySQL, PosgreSQL, Oracle, and many more. All of these employ SQL (*structured query language*) to pull data from the database. Thankfully, you don't need to know SQL
...
- `port` - the communication endpoint between R and the PostgreSQL database (this is typically always 5432 for PostgreSQL)
