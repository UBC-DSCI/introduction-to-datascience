...
In Table we summarize the `read_*` functions we covered in this chapter and include some other functions that read in different file formats, such as `read_tsv` as another way to read in tab-separated data and `read_csv2` for data separated by semicolons `;`. 

**Summary of `read_*` functions**
