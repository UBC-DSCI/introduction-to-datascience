...
- Sometimes you might run into data that is in such poor shape that none of the reading functions we cover in this chapter works. In that case, you can consult the [data import chapter](https://r4ds.had.co.nz/data-import.html) from [R for Data Science](https://r4ds.had.co.nz/), which goes into a lot more detail about how R parses text from files into data frames.
- The documentation for many of the reading functions we cover in this chapter can be found [on the tidyverse website](https://readr.tidyverse.org/reference/read_delim.html). This shows you the full set of arguments available for each function.
- The [rio package](https://github.com/leeper/rio) provides an alternative set of tools for reading and writing data in R. It aims to be a "swiss army knife" for data reading/writing/converting, and supports a wide variety of data types (including data formats generated by statistical software like SPSS and SAS).
- 
