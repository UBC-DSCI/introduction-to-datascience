...
- (*optional*) obtain data using APIs and web scraping
    ...
    - read data from Twitter using the `rtweet` package
    - compare downloading tabular data from a plain text file (e.g. `.csv`), accessing data from an API, and scraping the HTML source code a website
