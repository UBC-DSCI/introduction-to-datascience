# Setting up your own computer {#Setting-up-your-own-computer}

## Overview

Web-interface's for Jupyter and RStudio are an excellent place to get started,
and can also be great for collaboration to ensure that everyone on the team is
using the same version of all the software. However, most data scientists also
do some amount of work on their own computers (desktop or laptop) for reasons
of convenience, or access to more powerful compute resources. In this chapter we 
will show you how to install and configure R, R packages, Jupyter, RStudio and 
...
- install and configure the software needed to use R through the Jupyter Lab
interface on your own computer
- install and configure the software needed to use R through the RStudio
interface on your own computer
- install and configure the software needed to use Git on your own computer

## Installing software on your own computer

In this section we will provide instructions for installing the software 
required by this book on our own computer.Given that installation instructions 
can vary widely based on the computer setup we have created instructions for 
multiple operating systems. In particular, the installation instructions below 
have been verified to work on a computer that:
